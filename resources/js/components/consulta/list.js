                    ...
                    props.loading ? (
                        ...
                        items.length > 0 ? (
                            items.map((item) => {
                                ...
                                return (
                                    <tr>
                                        <td><a href={"politica/"+item.id+"/"+clean(item && item.nome ? item.nome : "")}>{item && item.nome ? item.nome : ""}</a></td>
                                        <td>{item.grande_area && item.grande_area.nome ? item.grande_area.nome : ""}</td>
                                        <td>{item.area && item.area.nome ? item.area.nome : ""}</td>
                                        <td>
                                            {
                                        ...
                                        <td>{item.ano ? item.ano.substring(0, 4) : ""}</td>
                                        <td>{dataFormatada}</td>
                                    </tr>
                                );
                            })
