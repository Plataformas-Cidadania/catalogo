(function () {
  ...
  function initTimeline(timeline) {
    ...
    timeline.lineLength = left + timeline.eventsMinDistance; // reveal timeline
  ...
  function initEvents(timeline) {
    var self = timeline; // click on arrow navigation
  ...
  function translateTimeline(timeline, direction) {
    ...
    timeline.line.style.transform = 'translateX(' + timeline.translate + 'px)'; // update the navigation items status (toggle inactive class)
