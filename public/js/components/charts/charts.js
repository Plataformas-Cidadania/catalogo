    ...
    _createClass(Charts, [{
        ...
        value: function componentWillReceiveProps(props) {
            ...
            for (var chart in data) {
                ...
                var tipoGrafico = data[chart].nome_tipo_grafico === "MultiBarChart" || data[chart].nome_tipo_grafico === "BarChart" ? "column" : data[chart].nome_tipo_grafico === "LinePlusBarChart" || data[chart].nome_tipo_grafico === "LineChart" ? "line" : data[chart].nome_tipo_grafico === "DonutChart" ? "pie" : data[chart].nome_tipo_grafico;
                ...
                for (var j in dataChart) {
                    ...
                    if (dataChart[j].hasOwnProperty('key') && (data[chart].nome_tipo_grafico === "LineChart" || data[chart].nome_tipo_grafico === "LinePlusBarChart")) {
                        ...
                        var colLabel = data[chart].nome_tipo_grafico === "LineChart" ? 'x' : 'label';
                        var colValue = data[chart].nome_tipo_grafico === "LineChart" ? 'y' : 'value';
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'a',
                                { className: 'tooltips float-right cursor', onClick: function () {
