...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/tipoPoliticaCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="tipoPoliticaCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-square" aria-hidden="true"></i>&nbsp;TipoPoliticas</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                <i ng-show="form.file.$error.maxSize || form.fileDrop.$error.maxSize" style="margin-left: 10px;">
                    Arquivo muito tipo <% errorFile.size / 1000000|number:1 %>MB: máximo 2MB
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tbody>
                        <tr ng-repeat="tipoPolitica in tipoPoliticas">
                            <td><% tipoPolitica.id %></td>
                           {{-- <td><img ng-show="tipoPolitica.imagem" ng-src="imagens/tipoPoliticas/xs-<% tipoPolitica.imagem %>" width="60"></td>--}}
                            <td><% tipoPolitica.nome %></td>
                            <td><% tipoPolitica.mes %></td>
                            <td class="text-right">
                                <div>
                                    {{--<a href="cms/items/<% tipoPolitica.id %>"><i class="fa fa-sitemap fa-2x" title="Itens"></i></a>&nbsp;&nbsp;--}}
                                    <a href="cms/tipo-politica/<% tipoPolitica.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;{{--<% mensagemStatus %><% idStatus %>--}}
                                    {{--<a  ng-class="<% tipoPolitica.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(tipoPolitica.id, tipoPolitica.status);"></i></a>&nbsp;&nbsp;--}}
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" style="cursor:pointer;"  ng-click="perguntaExcluir(tipoPolitica.id, tipoPolitica.nome, tipoPolitica.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            {{--<div class="col-md-3">
                                <img  ng-src="imagens/tipoPoliticas/xs-<% imagemExcluir %>" width="100">
                            </div>--}}
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
