...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/categoriaPoliticaCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="categoriaPoliticaCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-square" aria-hidden="true"></i>&nbsp;CategoriaPoliticas</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Categoria Politica</button>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <br>
                    <div><% mensagemCategoriaPolitica %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tbody>
                        <tr ng-repeat="categoriaPolitica in categoriaPoliticas">
                            <td><% categoriaPolitica.id %></td>
                           {{-- <td><img ng-show="categoriaPolitica.imagem" ng-src="imagens/categoriaPoliticas/xs-<% categoriaPolitica.imagem %>" width="60"></td>--}}
                            <td><% categoriaPolitica.nome %></td>
                            <td><% categoriaPolitica.mes %></td>
                            <td class="text-right">
                                <div>
                                    {{--<a href="cms/items/<% categoriaPolitica.id %>"><i class="fa fa-sitemap fa-2x" title="Itens"></i></a>&nbsp;&nbsp;--}}
                                    <a href="cms/categoria-politica/<% categoriaPolitica.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;{{--<% mensagemStatus %><% idStatus %>--}}
                                    {{--<a  ng-class="<% categoriaPolitica.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(categoriaPolitica.id, categoriaPolitica.status);"></i></a>&nbsp;&nbsp;--}}
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" style="cursor:pointer;"  ng-click="perguntaExcluir(categoriaPolitica.id, categoriaPolitica.nome, categoriaPolitica.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            {{--<div class="col-md-3">
                                <img  ng-src="imagens/categoriaPoliticas/xs-<% imagemExcluir %>" width="100">
                            </div>--}}
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
