    ...
    <div ng-controller="alterarAreaCtrl">
        <div class="box-padrao">
            ...
            <div ng-init="carregaImagem('{{$area->imagem}}', '{{$area->arquivo}}'); detalhar({{$area->id}})">
                ...
                <a href="arquivos/areas/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                ...
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <br>
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.area.$dirty">Salvar</button>
                    </div>
