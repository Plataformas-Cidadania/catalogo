...
@section('content')
    ...
    <div ng-controller="alterarArquivoCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($arquivo);?>
            <div ng-init="carregaImagem('{{$arquivo->imagem}}', '{{$arquivo->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($arquivo, ['name' =>'form']) !!}
                ...
                <a href="arquivos/arquivos/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                ...
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.arquivo.$dirty">Salvar</button>
                    </div>
