...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/orgaoCtrl.js') !!}
<script>
    $(function () {
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tbody>
                        <tr ng-repeat="orgao in orgaos">
                            <td><% orgao.id %></td>
                           {{-- <td><img ng-show="orgao.imagem" ng-src="imagens/orgaos/xs-<% orgao.imagem %>" width="60"></td>--}}
                            <td><% orgao.nome %></td>
                            <td><% orgao.mes %></td>
                            <td class="text-right">
                                <div>
                                    {{--<a href="cms/items/<% orgao.id %>"><i class="fa fa-sitemap fa-2x" title="Itens"></i></a>&nbsp;&nbsp;--}}
                                    <a href="cms/orgao/<% orgao.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;{{--<% mensagemStatus %><% idStatus %>--}}
                                    {{--<a  ng-class="<% orgao.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(orgao.id, orgao.status);"></i></a>&nbsp;&nbsp;--}}
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" style="cursor:pointer;"  ng-click="perguntaExcluir(orgao.id, orgao.nome, orgao.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            {{--<div class="col-md-3">
                                <img  ng-src="imagens/orgaos/xs-<% imagemExcluir %>" width="100">
                            </div>--}}
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
