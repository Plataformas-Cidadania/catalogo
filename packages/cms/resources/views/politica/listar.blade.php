                           ...
                           {{-- <td><img ng-show="politica.imagem" ng-src="imagens/politicas/xs-<% politica.imagem %>" width="60"></td>--}}
                            ...
                            <td class="text-right">
                                <div>
                                    ...
                                    <a><i data-toggle="modal" data-target="#modalPoliticaOrgao" class="fa fa-square fa-2x" style="cursor:pointer;" ng-click="modalPoliticaOrgao(politica.id, politica.nome)"></i></a>
