...
;
    ...
    public function __construct(GrandeAreaController $repo)
    {
        $this->repo = $repo;
    }
    ...
    public function getAll(): JsonResponse
    {
        ...
        return $this->successResponse(
            'Grandes Areas retornadas com sucesso',
            $res
        );
    }
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            return $this->successResponse(
			    'Grande Area '.$res->id.' foi adicionado',
			    $this->transform($res)
			);
    ...
    protected function transform(GrandeArea $model): array
    {
        return [
            'id' => $model->id,
            'nome' => $model->nome,
